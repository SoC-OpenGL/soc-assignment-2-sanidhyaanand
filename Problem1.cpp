...
int main()
{
    ...
    Shader ourShader("C:/Users/Sanidhya/Desktop/Shaders/shaderall3.vs", "C:/Users/Sanidhya/Desktop/Shaders/shaderall3.fs");
   ...
   // glEnableVertexAttribArray(2);
    ...
    unsigned char* data = stbi_load("C:/Users/Sanidhya/Desktop/Images/bruh.jpeg", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    // load image, create texture and generate mipmaps
    data = stbi_load("C:/Users/Sanidhya/Desktop/Images/awesomeface.png", &width, &height, &nrChannels, 0);
    if (data)
    {
