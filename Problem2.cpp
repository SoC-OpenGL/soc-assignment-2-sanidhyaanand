...
int main()
{
    ...
    // -------------------------
    Shader ourShader("Shaders/shaderall3.vs", "Shaders/shaderall3.fs");
    Shader skyboxShader("D:/glowing-chainsaw/Shaders/skyboxshad.vs", "D:/glowing-chainsaw/Shaders/skyboxshad.fs"); //try converting paths to format of paths of the previous shaders
    ...
    unsigned int cubeTexture = loadTexture("Images/bruh.jpeg");
    ...
    //shader configuration, texture passing
    ourShader.use();
