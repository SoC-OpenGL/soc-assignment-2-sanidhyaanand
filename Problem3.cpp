...
int main()
{
    ...
    // -------------------------
    Shader ourShader("D:/glowing-chainsaw/Shaders/lightobjshad.vs", "D:/glowing-chainsaw/Shaders/lightobjshadspotlight.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::vec3 lightPos(1.5 + 3.0f * cos(angle * 0.5), 1.0f, 2.0f * sin(angle)); //light position
        ourShader.setVec3("viewPos", camera.Position); //viewer position

        //light and material properties
        //-----------------------------
        //ourShader.setVec3("light.position", lightPos);              //comment this for spotlight
        ...
        ourShader.setVec3("light.position", camera.Position);     //uncomment this for spotlight
